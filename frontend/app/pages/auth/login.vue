...
<template>
  <div class="flex flex-col gap-6">
    <div class="text-center">
      <h1 class="text-lg font-semibold text-highlighted">Welcome back</h1>
      <p class="mt-1 text-sm text-dimmed">Sign in to continue your interview prep</p>
    </div>

    <UCard v-if="showUnverifiedCard" class="border border-warning/30 bg-warning/5">
      <div class="flex flex-col items-center gap-3 text-center">
        <UIcon name="i-lucide-mail-warning" class="size-10 text-warning" />

        <div>
          <h2 class="text-base font-semibold text-highlighted">Email Not Verified</h2>
          <p class="mt-1 text-sm text-dimmed">Your account has not been verified yet.</p>
        </div>
